  // The button send NOTE_ON/NOTE_OFF notes on MIDI channels 1, 2, 3
// The potentiometer/controller selects the MIDI note
// The blue button only sends NOTE_ON for sustained sounds
// Board: "Sparkfun Pro Micro
// ** caution! Select correct voltage in the IDE or you will brick the
//**microcontroller! **
// Tools ... Processor ... (3.3v or 5v)
// see:
//https://learn.sparkfun.com/tutorials/pro-micro--fio-v3-hookup-guide/troubleshooting
//-and-faq
#include <MIDIUSB.h>
// Define MIDI Notes
#define NOTE_C1  33
...
#define MIDI_CONTROLLER_X 16 // Additional MIDI controller for joystick X
#define MIDI_CONTROLLER_Y 17 // Additional MIDI controller for joystick Y
void setup() {
 Serial.begin(9600);
...
// Rest of your existing functions (noteOn, noteOff, sendNoteOn, sendNoteOff,
//controlChange) here...
